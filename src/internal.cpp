...
{   
    ...
    {
        internal.msgPointcloud.header.frame_id=rosparam.globalFrame;
...
void Internal::PubRigidbodyPose(sRigidBodyData &data, Internal &internal)
{
    ...
    msgRigidBodyPose.header.frame_id = rosparam.globalFrame;
    ...
    msgTFRigidBodies.header.frame_id = rosparam.globalFrame;
...
{   
    ...
    {   internal.UnlabeledCount+=1;
        ...
        msgMarkerPose.header.frame_id = rosparam.globalFrame;
        ...
        msgTFMarker.header.frame_id = rosparam.globalFrame;
